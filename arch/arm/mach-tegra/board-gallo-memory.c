...
static const struct tegra_emc_table gallo_emc_tables_Elpida_EDB8132B2PB_6D_F_300Mhz[] = {
	{
...
static const struct tegra_emc_table gallo_emc_tables_Hynix_H8TJR00X0MLR_0YM_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table gallo_emc_tables_elpida_400Mhz[] = {
{
...
static const struct tegra_emc_chip gallo_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = gallo_emc_tables_Elpida_EDB8132B2PB_6D_F_300Mhz,
		.table_size = ARRAY_SIZE(gallo_emc_tables_Elpida_EDB8132B2PB_6D_F_300Mhz)
	},
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = gallo_emc_tables_Hynix_H8TJR00X0MLR_0YM_300Mhz,
		.table_size = ARRAY_SIZE(gallo_emc_tables_Hynix_H8TJR00X0MLR_0YM_300Mhz)
	},
};

static const struct tegra_emc_chip gallo_t25_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = gallo_emc_tables_elpida_400Mhz,
		.table_size = ARRAY_SIZE(gallo_emc_tables_elpida_400Mhz)
	},
};
...
{
#ifdef GALLO_DISABLE_DDR_DFVS
	pr_info("%s: disable DDR DVFS!!!", __func__);
	return 0;
#else
	...
	if (BoardInfo.sku == TEGRA25_SKU) {
		tegra_init_emc(gallo_t25_emc_chips,
			ARRAY_SIZE(gallo_t25_emc_chips));
	} else {
		tegra_init_emc(gallo_emc_chips,
			ARRAY_SIZE(gallo_emc_chips));
	}
	return 0;
