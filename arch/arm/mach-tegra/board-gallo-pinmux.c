/*
 * arch/arm/mach-tegra/board-gallo-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config gallo_drive_pinmux[] = {
	DEFAULT_DRIVE(DDC),
	DEFAULT_DRIVE(VI1),
	DEFAULT_DRIVE(SDIO1),
	DEFAULT_DRIVE(DAP1),
...
static __initdata struct tegra_drive_pingroup_config gallo_drive_pinmux_LCD_3G_SKU[] = {
	SET_DRIVE(LCD1,	DISABLE, ENABLE, DIV_4, 19, 19, SLOWEST, SLOWEST),
	SET_DRIVE(LCD2,	DISABLE, ENABLE, DIV_4, 19, 19, SLOWEST, SLOWEST),
};

static __initdata struct tegra_drive_pingroup_config gallo_drive_pinmux_LCD_Wifi_SKU[] = {
	SET_DRIVE(LCD1,	DISABLE, ENABLE, DIV_1, 31, 31, SLOWEST, SLOWEST),
	SET_DRIVE(LCD2,	DISABLE, ENABLE, DIV_1, 31, 31, SLOWEST, SLOWEST),
};


static __initdata struct tegra_pingroup_config gallo_pinmux[] = {
	{TEGRA_PINGROUP_ATA,   TEGRA_MUX_IDE,           TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_GPU7,  TEGRA_MUX_RTCK,          TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_KBCA,  TEGRA_MUX_KBC,           TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_KBCD,  TEGRA_MUX_KBC,           TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_LCSN,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_LM1,   TEGRA_MUX_RSVD4,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_LPW1,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_LSDA,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_LVP0,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_SLXC,  TEGRA_MUX_SDIO3,         TEGRA_PUPD_PULL_UP,   TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_SPIE,  TEGRA_MUX_SPI1,          TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},
...
void __init gallo_pinmux_init(bool is_wifi_sku)
{
	tegra_pinmux_config_table(gallo_pinmux, ARRAY_SIZE(gallo_pinmux));
	tegra_drive_pinmux_config_table(gallo_drive_pinmux,
					ARRAY_SIZE(gallo_drive_pinmux));
	if (is_wifi_sku)
	{
		tegra_drive_pinmux_config_table(gallo_drive_pinmux_LCD_Wifi_SKU,
					ARRAY_SIZE(gallo_drive_pinmux_LCD_Wifi_SKU));
	}
	else
	{
		tegra_drive_pinmux_config_table(gallo_drive_pinmux_LCD_3G_SKU,
					ARRAY_SIZE(gallo_drive_pinmux_LCD_3G_SKU));
	}
}
