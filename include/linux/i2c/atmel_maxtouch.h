...
/* Object types */
#define MXT_T2_DEBUG_DELTAS				2
#define MXT_T3_DEBUG_REFERENCES				3
#define MXT_T5_GEN_MESSAGEPROCESSOR			5
#define MXT_T6_GEN_COMMANDPROCESSOR			6
#define MXT_T7_GEN_POWERCONFIG				7
#define MXT_T8_GEN_ACQUIRECONFIG			8
#define MXT_T9_TOUCH_MULTITOUCHSCREEN			9
#define MXT_T10_TOUCH_SINGLETOUCHSCREEN			10
#define MXT_T11_TOUCH_XSLIDER				11
#define MXT_T12_TOUCH_YSLIDER				12
#define MXT_T13_TOUCH_XWHEEL				13
#define MXT_T14_TOUCH_YWHEEL				14
#define MXT_T15_TOUCH_KEYARRAY				15
#define MXT_T19_SPT_GPIOPWM				19
#define MXT_T20_PROCI_GRIPFACESUPPRESSION		20
#define MXT_T22_PROCG_NOISESUPPRESSION			22
#define MXT_T23_TOUCH_PROXIMITY				23
#define MXT_T24_PROCI_ONETOUCHGESTUREPROCESSOR		24
#define MXT_T25_SPT_SELFTEST				25
#define MXT_T26_DEBUG_CTERANGE				26
#define MXT_T27_PROCI_TWOTOUCHGESTUREPROCESSOR		27
#define MXT_T28_SPT_CTECONFIG				28
#define MXT_T31_TOUCH_KEYSET				31
#define MXT_T32_TOUCH_XSLIDERSET			32
#define MXT_T37_DEBUG_DIAGNOSTIC			37
#define MXT_T38_USER_INFO				38
#define MXT_T40_PROCI_GRIPSUPPRESSION			40
#define MXT_T41_PROCI_PALMSUPPRESSION			41
#define MXT_T43_SPT_DIGITIZER				43
...
#define	MXT_ADDR_T9_MOVFILTER				13
#define	MXT_ADDR_T9_MAX_NUM_TOUCHES			14
#define	MXT_ADDR_T9_XRANGE				18
#define	MXT_ADDR_T9_YRANGE				20
#define	MXT_ADDR_T9_YEDGECTRL				28
...
#define MXT_BACKUP		4	/* Backups the current state of registers to NVM */
...
#ifdef INCLUDE_MXT_STATIC_FUNCTION
...
struct mxt_data {
	...
	struct delayed_work dwork_release;
	u8 xpos_format;
	u8 ypos_format;
...
extern struct mxt_data *mxt;
extern int debug;
extern u8 t7_cfg[2], t7_cfg_free_run[2];
extern u8 self_test_result;

#define mxt_debug(level, ...) \
	do { \
		if (debug >= (level)) \
			printk(KERN_INFO "[Touch] - DEBUG - " __VA_ARGS__); \
	} while (0)
...
#define Write_Byte(object, offset, data) \
			  mxt_write_byte( \
				mxt->client, \
				MXT_BASE_ADDR(object, mxt) + offset, \
				(data) & 0xFF)
...
#endif /* INCLUDE_MXT_STATIC_FUNCTION */
