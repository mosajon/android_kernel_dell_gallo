...
struct wm8903_platform_data {
	...
	u16 spkl_vol;
	u16 spkr_vol;
	u16 int_mic_adcl_vol;
	u16 int_mic_adcr_vol;
	u16 hs_mic_adcl_vol;
	u16 hs_mic_adcr_vol;
	u16 lin_vol;
	u16 rin_vol;

	bool int_mic_record_drc;
	bool int_mic_incall_drc;
	bool hs_mic_record_drc;
	bool hs_mic_incall_drc;

	u16 int_mic_record_drc0;
	u16 int_mic_record_drc1;
	u16 int_mic_record_drc2;
	u16 int_mic_record_drc3;
	u16 int_mic_incall_drc0;
	u16 int_mic_incall_drc1;
	u16 int_mic_incall_drc2;
	u16 int_mic_incall_drc3;
	u16 hs_mic_record_drc0;
	u16 hs_mic_record_drc1;
	u16 hs_mic_record_drc2;
	u16 hs_mic_record_drc3;
	u16 hs_mic_incall_drc0;
	u16 hs_mic_incall_drc1;
	u16 hs_mic_incall_drc2;
	u16 hs_mic_incall_drc3;

	bool int_mic_record_hpf;
	bool int_mic_incall_hpf;
	bool hs_mic_record_hpf;
	bool hs_mic_incall_hpf;

	int int_mic_record_hpf_cut;
	int int_mic_incall_hpf_cut;
	int hs_mic_record_hpf_cut;
	int hs_mic_incall_hpf_cut;
