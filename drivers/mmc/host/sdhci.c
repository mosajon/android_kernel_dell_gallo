...
static void sdhci_do_initial_sequence(struct mmc_host *mmc)
{
	struct sdhci_host *host;
...
static void sdhci_power_off(struct mmc_host *mmc)
{
	struct sdhci_host *host;
...
static bool sdhci_is_polling_timeout(struct mmc_host *mmc)
{
	struct sdhci_host *host;
	bool ret = true;
	...
	if (host->ops->is_polling_timeout)
		ret = host->ops->is_polling_timeout(host);
...
static const struct mmc_host_ops sdhci_ops = {
	...
	.get_cd		= sdhci_get_cd,
	.do_initial_sequence = sdhci_do_initial_sequence,
	.enable_sdio_irq = sdhci_enable_sdio_irq,
	.power_off = sdhci_power_off,
	.is_polling_timeout = sdhci_is_polling_timeout,
};
